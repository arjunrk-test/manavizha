            ...
            {preview ? (
              <div className="relative w-full max-w-lg mx-auto group">
                ...
                <img
                  ...
                  className="relative w-full h-auto rounded-[2.5rem] border-8 border-white shadow-[0_30px_60px_-15px_rgba(59,185,172,0.15)] transition-all duration-700 group-hover:scale-[1.02] group-hover:-translate-y-2"
                />
                <Button
                  type="button"
                  variant="destructive"
                  ...
                  className="absolute -top-4 -right-4 h-12 w-12 rounded-full shadow-2xl border-4 border-white bg-primary hover:bg-primary transition-transform group-hover:scale-110 active:scale-90"
                >
        ...
        <div className={SETUP_SECTION_CARD}>
          ...
          <div className="flex flex-col md:flex-row gap-3 relative z-10 w-full md:w-auto">
            ...
            <Button
                ...
                disabled={isFetchingDetailed}
                variant="outline"
                className="h-14 px-6 rounded-2xl border-primary text-primary bg-white/50 backdrop-blur-sm font-black text-[10px] uppercase tracking-[0.2em] transition-all hover:bg-primary active:scale-95 disabled:opacity-50"
            >
                {isFetchingDetailed ? <Loader2 className="h-5 w-5 animate-spin mr-3" /> : <Eye className="h-5 w-5 mr-3" />}
                Vakkiyam
            </Button>
