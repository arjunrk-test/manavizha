  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className={`${showDetailed ? 'max-w-4xl p-1 bg-transparent shadow-none' : 'sm:max-w-md bg-white dark:bg-gray-900 shadow-2xl p-0'} border-none overflow-y-auto max-h-[90vh]`}>
        ...
        {!showDetailed ? (
          <>
            <div className="bg-gradient-to-r from-[#3bb9ac] to-[#3bb9ac] p-6 text-white text-center relative">
          ...
          {!result ? (
            ...
            >
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="rounded-xl border-gray-200 focus:ring-[#3bb9ac]"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  className="w-full rounded-xl border-gray-200 p-2 text-sm bg-white dark:bg-gray-800 border focus:ring-2 focus:ring-[#3bb9ac] outline-none"
                >
              ...
              <Button 
                ...
                className="w-full h-12 bg-[#3bb9ac] hover:bg-[#2fa085] rounded-xl font-bold shadow-lg shadow-[#3bb9ac]/20 gap-2"
              >
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-emerald-50 dark:bg-primary p-4 rounded-2xl border border-emerald-100 dark:border-emerald-800/50 text-center">
                  <Star className="h-5 w-5 text-[#3bb9ac] mx-auto mb-2" />
                  <p className="text-[10px] uppercase font-bold text-gray-400">Your Star</p>
                  <p className="text-xl font-bold text-[#3bb9ac] dark:text-emerald-400">{result.star}</p>
                </div>
                <div className="bg-primary dark:bg-primary p-4 rounded-2xl border border-primary dark:border-primary text-center">
                  <Sparkles className="h-5 w-5 text-[#3bb9ac] mx-auto mb-2" />
                  <p className="text-[10px] uppercase font-bold text-gray-400">Your Rashi</p>
                  <p className="text-xl font-bold text-[#3bb9ac] dark:text-primary">{result.rashi}</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 mt-6">
                ...
                <div className="flex gap-3">
                  ...
                  <Button 
                    onClick={handleSave} 
                    disabled={isSaving}
                    className="flex-[2] bg-gradient-to-r from-[#3bb9ac] to-[#3bb9ac] hover:opacity-90 rounded-xl h-11 font-bold shadow-lg gap-2"
                  >
