        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            >
                ...
                <div className="flex justify-between items-center">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                        <UserCircle2 className="h-8 w-8 text-[#3bb9ac]" />
                        Manage Parent Access
                    </h1>
                    {!showForm && parents.length < 2 && (
                        <Button
                            onClick={() => setShowForm(true)}
                            className="bg-gradient-to-r from-[#1F4068] to-[#3bb9ac] hover:opacity-90"
                        >
            ...
            {showForm && (
                <motion.div
                    ...
                    className="mb-8"
                >
                    <Card className="border-2 border-[#3bb9ac]/20">
                        <CardHeader className="bg-[#3bb9ac]/5 dark:bg-[#3bb9ac]/10 border-b border-[#3bb9ac]/10">
                        ...
                        <CardContent className="pt-6">
                            <form onSubmit={handleCreateParent} className="space-y-4">
                                ...
                                <div className="flex gap-3 justify-end pt-4">
                                    ...
                                    <Button
                                        type="submit"
                                        className="bg-[#3bb9ac] hover:bg-[#3a0066] text-white"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {parents.map((parent) => (
                        <Card key={parent.id} className="relative overflow-hidden group">
                            <div className="absolute top-0 left-0 w-1 h-full bg-[#3bb9ac]" />
                            <CardContent className="p-6">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <span className="inline-block px-2 py-1 bg-[#3bb9ac]/10 text-[#3bb9ac] text-xs font-semibold rounded-full mb-2">
                                            {parent.role}
                                        </span>
