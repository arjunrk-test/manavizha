  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md bg-white dark:bg-gray-900 border-none shadow-2xl p-0 overflow-hidden">
        <div className="bg-gradient-to-br from-[#3bb9ac] to-[#6A5ACD] p-6 text-white text-center">
          <Heart className="h-10 w-10 text-primary mx-auto mb-3 animate-pulse" />
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-700/50">
            <div>
              ...
              <p className="text-3xl font-black text-[#3bb9ac] dark:text-emerald-400">{score}<span className="text-lg text-gray-400">/10</span></p>
            </div>
