...
export function AdminProfileStatsPanel({ stats }: { stats: ProfileStats }) {
        ...
        <div className="relative p-4 sm:p-5">
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <Link
              ...
              aria-label={`${stats.total} active profiles`}
            >
              <div className="relative h-[132px] w-[132px] sm:h-[148px] sm:w-[148px]">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[10px] font-medium text-gray-500 mt-1">profiles</span>
                </div>
              </div>
            </Link>
