...
export function TestimonialsSection() {
  return (
    <section id="testimonials" className="py-32 bg-gradient-to-br from-violet-50 via-purple-50 to-amber-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-violet-700 dark:text-violet-400 font-medium mb-6 shadow-lg"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
            >
              <Card className="h-full border-0 shadow-xl hover:shadow-2xl transition-all duration-300 bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl overflow-hidden relative group">
                {/* Decorative gradient */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-500 via-purple-500 to-amber-500" />
                
                <CardContent className="p-8">
                  <div className="text-5xl mb-4">{testimonial.image}</div>
                  <Quote className="h-8 w-8 text-violet-600/50 mb-4" />
