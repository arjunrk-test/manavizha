          ...
          >
            <div className="p-3 border-b sticky top-0 bg-white z-10">
                <div className="relative group">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#3bb9ac]/40 group-focus-within:text-[#3bb9ac] transition-colors" />
                    <Input 
            ...
            <div className="p-1">
                ...
                <DropdownMenuItem
                    ...
                    className="flex items-center justify-between py-3 px-4 cursor-pointer rounded-2xl hover:bg-[#3bb9ac]/5 focus:bg-[#3bb9ac]/5 transition-colors"
                >
                    <span className="text-sm font-medium text-gray-700">{c.name}</span>
                    {selectedCountry === c.name && <Check className="h-4 w-4 text-[#3bb9ac]" />}
                </DropdownMenuItem>
                ))}
            </div>
          </DropdownMenuContent>
          ...
          >
            ...
            <div className="p-1">
                ...
                >
                    ...
                    {selectedState === s.name && <Check className="h-4 w-4 text-[#3bb9ac]" />}
                </DropdownMenuItem>
                ))}
            </div>
          </DropdownMenuContent>
          ...
          >
            ...
            <div className="p-1">
                ...
                >
                    ...
                    {selectedCity === c && <Check className="h-4 w-4 text-[#3bb9ac]" />}
                </DropdownMenuItem>
                ))}
            </div>
          </DropdownMenuContent>
