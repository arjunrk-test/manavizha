          ...
          <div className="flex items-center justify-between mb-4 gap-2">
            ...
            <div className="flex items-center gap-1 overflow-hidden">
                <select 
                    ...
                    className="bg-transparent font-bold text-[11px] uppercase tracking-widest text-[#3bb9ac] border-none outline-none cursor-pointer hover:text-primary transition-colors"
                >
              ...
              <motion.button
                ...
                className={`
                  ...
                  ${isSameDay(day, date || new Date(0)) 
                    ? "bg-gradient-to-br from-[#3bb9ac] to-[#3bb9ac] text-white shadow-lg" 
