            ...
            <div className="relative z-10 py-8">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <Section title="Personal Details" editing={ed("personal")} saving={sv("personal")}
                        ...
                        <F label="Date of Birth" value={personal.dob} type="date" editing={ed("personal")} fieldKey="dob" onChange={(k, v) => setPersonal((p: any) => ({ ...p, [k]: v }))} />
                        ...
                        <F label="Complexion" value={personal.complexion} editing={ed("personal")} fieldKey="complexion" onChange={(k, v) => setPersonal((p: any) => ({ ...p, [k]: v }))} />
                    ...
                    <Section title="Contact Details" editing={ed("contact")} saving={sv("contact")}
                        ...
                        {(["phone", "address", "city", "state", "country", "pincode"] as const).map(k => (
                            <F key={k} label={k.charAt(0).toUpperCase() + k.slice(1)} value={contact[k]}
                                editing={ed("contact")} fieldKey={k} onChange={(fk, v) => setContact((p: any) => ({ ...p, [fk]: v }))} />
                        ))}
                    </Section>
                    ...
                    <Section title="Interests" editing={ed("interests")} saving={sv("interests")}
                        ...
                        {(["hobbies", "sports", "music", "preferred_partner"] as const).map(k => (
                            <F key={k} label={k.replace("_", " ").replace(/\b\w/g, l => l.toUpperCase())} value={interests[k]}
                                editing={ed("interests")} fieldKey={k} onChange={(fk, v) => setInterests((p: any) => ({ ...p, [fk]: v }))} />
                        ))}
                    </Section>
