            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <div className="relative w-full max-w-xs">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-9 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3bb9ac]/20 focus:border-[#3bb9ac] transition-all"
                />
                {searchQuery && (
            ...
            <TabsContent value="admin" className="mt-6">
              <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-lg shadow-sm border border-gray-200/60 dark:border-gray-700/60">
                <div className="p-6 border-b border-gray-200/60 dark:border-gray-700/60 flex items-center justify-between">
                  ...
                  <Button onClick={() => handleOpenAdminDialog("add")} className="bg-[#3bb9ac] hover:bg-[#3bb9ac]/90">
            ...
            <TabsContent value="partner" className="mt-6">
              ...
              <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-lg shadow-sm border border-gray-200/60 dark:border-gray-700/60">
                <div className="p-6 border-b border-gray-200/60 dark:border-gray-700/60 flex items-center justify-between">
                  ...
                  <Button onClick={() => setIsPartnerDialogOpen(true)} className="bg-[#3bb9ac] hover:bg-[#3bb9ac]/90">
                      ...
                      {filteredPartners.length === 0 ? (
                        ...
                        filteredPartners.map((partner: any) => (
                          <TableRow key={partner.id || partner.partner_id}>
                            ...
                            <TableCell className="text-primary dark:text-primary font-medium">{partner.womenReferrals}</TableCell>
                            <TableCell>
                              <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 focus-within:ring-2 focus-within:ring-[#3bb9ac] overflow-hidden w-20">
                                <input
                                  type="number"
          ...
          <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-[#3bb9ac]/20 focus:border-[#3bb9ac]"
                  >
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <Button
                ...
                className={adminDialogMode === "revoke" ? "bg-red-600 hover:bg-red-700 text-white" : "bg-[#3bb9ac] hover:bg-[#3bb9ac]/90"}
              >
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <Button
                ...
                className="bg-[#3bb9ac] hover:bg-[#3bb9ac]/90"
