            ...
            <div className="relative z-10 py-8">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    {(raw.emp || raw.bus || raw.stu) && (
                        <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200/60 dark:border-gray-700/60 p-6 mb-6">
                            <h2 className="text-lg font-semibold text-[#3bb9ac] dark:text-emerald-400 mb-4 pb-2 border-b border-gray-100 dark:border-gray-700">Professional Details</h2>
                    ...
                    <Section title="Family Details" canEdit={canEdit} editing={ed("family")} saving={sv("family")}
                        ...
                        <F label="Kulam / Kilai (Optional)" value={family.kulam} editing={canEdit && ed("family")} fieldKey="kulam" onChange={(k, v) => setFamily((p: any) => ({ ...p, [k]: v }))} />
                        <F label="Gotram (Optional)" value={family.gotram} editing={canEdit && ed("family")} fieldKey="gotram" onChange={(k, v) => setFamily((p: any) => ({ ...p, [k]: v }))} />
