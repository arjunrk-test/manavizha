  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        {/* Footer - Sticky */}
        <footer className="mt-auto sticky bottom-0 z-50 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-t border-gray-200/60 dark:border-gray-700/60 pt-4 pb-4">
