        ...
        return (
            <div className="sds-glass rounded-[1.5rem] p-3 border-white/40 shadow-xl overflow-hidden h-full flex flex-col relative group">
                <div className="flex items-center justify-between mb-2">
                    <h3 className="text-[9px] font-black text-[#3bb9ac]/60 uppercase tracking-[0.4em]">{title}</h3>
                    {isManual && (
                        <Button 
                            variant="ghost" 
                            size="icon" 
                            onClick={clearManualPlacements}
                            className="h-5 w-5 text-primary hover:text-primary hover:bg-primary rounded-full"
                        >
                ...
                <div className="grid grid-cols-4 border border-[#3bb9ac]/10 rounded-xl overflow-hidden relative shadow-inner bg-white/50 flex-1">
                    {gridPositions.map((pos, idx) => {
                        if (pos.id === -1) return (
                            <div key={idx} className="bg-[#3bb9ac]/5 flex items-center justify-center p-1">
                                {idx === 5 && (
                                    <div className="text-center">
                                        <p className="text-[7px] font-black text-[#3bb9ac]/30 uppercase tracking-[0.3em]">{type === 'rasi' ? "இராசி" : "அம்சம்"}</p>
                                        <Star className="h-4 w-4 text-[#3bb9ac]/10 mx-auto mt-0.5" />
                                    </div>
                                )}
                            </div>
                        )
                        ...
                        return (
                            <Popover key={idx}>
                                <PopoverTrigger asChild>
                                    <div 
                                        className={cn(
                                            "border border-[#3bb9ac]/10 p-0.5 flex flex-col items-center justify-center min-h-[60px] relative transition-all",
                                            isManual ? "cursor-pointer hover:bg-indigo-50/50" : "hover:bg-[#3bb9ac]/5"
                                        )}
                                    >
                                        <span className="absolute top-1 left-1 text-[7px] text-[#3bb9ac]/30 font-black uppercase tracking-tighter">
                                            {pos.label}
                                        </span>
                                                    ...
                                                    className={cn(
                                                        ...
                                                        p.isLagnam 
                                                            ...
                                                            : p.name === 'Moon'
                                                                ...
                                                                : "bg-white/80 text-[#3bb9ac] border-gray-100"
                                                    )}
                                                >
                                                    {p.tamilAbbr}
                                                </motion.span>
        ...
        <div className="lg:col-span-3 sticky top-4">
            ...
            >
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-lg bg-indigo-50 flex items-center justify-center">
                            {entryMode === 'auto' ? <Calendar className="h-3.5 w-3.5 text-[#3bb9ac]" /> : <Keyboard className="h-3.5 w-3.5 text-indigo-600" />}
                        </div>
                    ...
                    <div className="flex bg-indigo-50 rounded-lg p-0.5">
                        <button 
                            ...
                            className={cn(
                                ...
                                entryMode === 'auto' ? "bg-white text-[#3bb9ac] shadow-sm" : "text-gray-400 hover:text-indigo-600"
                            )}
                        ...
                        <button 
                            ...
                            className={cn(
                                "p-1.5 rounded-md transition-all",
                                entryMode === 'manual' ? "bg-white text-[#3bb9ac] shadow-sm" : "text-gray-400 hover:text-indigo-600"
                            )}
                ...
                <AnimatePresence mode="wait">
                    {entryMode === 'auto' ? (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <p className="text-[9px] font-black text-[#3bb9ac]/40 uppercase tracking-[0.2em] ml-1">OCR Scan</p>
                                <input 
                                    type="file" 
                                    ref={fileInputRef} 
                                    className="hidden" 
                                ...
                                <Button 
                                    ...
                                    className="w-full h-12 rounded-2xl border-indigo-100 bg-white hover:bg-indigo-50 border-dashed text-[#3bb9ac] flex flex-col items-center justify-center gap-1 group"
                                >
                ...
                <Button 
                    ...
                    className="w-full h-12 bg-[#3bb9ac] hover:bg-[#2fa085] text-white rounded-xl font-black text-[11px] uppercase tracking-[0.2em] shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2 mt-6"
                >
        ...
        <div className="lg:col-span-9 space-y-6">
            ...
            >
                <div className="relative z-10 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#3bb9ac] to-[#3bb9ac] flex items-center justify-center shadow-lg transform rotate-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <div className="bg-[#3bb9ac]/10 text-[#3bb9ac] px-2 py-0.5 rounded-md text-[8px] font-black uppercase tracking-widest border border-[#3bb9ac]/20">
                        ...
                        <button 
                            ...
                            className={cn(
                                ...
                                calculationMethod === 'thirukanitham' 
                                    ? "bg-[#3bb9ac]/10 text-[#3bb9ac] border-[#3bb9ac]/20" 
                        ...
                        />
                         <div className="p-4 bg-gray-50 flex items-center justify-end border-t border-gray-100">
                           <Button 
                             onClick={handleSave} 
                             disabled={isSaving}
                             className="bg-gradient-to-r from-[#3bb9ac] to-[#3bb9ac] hover:opacity-90 rounded-xl h-11 font-bold shadow-lg gap-2 px-6"
                           >
