              ...
              <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg bg-gradient-to-br from-[#1F4068]/10 to-[#3bb9ac]/10 dark:from-[#1F4068]/30 dark:to-[#3bb9ac]/30">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg bg-gradient-to-br from-[#1F4068]/10 to-[#3bb9ac]/10 dark:from-[#1F4068]/30 dark:to-[#3bb9ac]/30">
                      <MapPin className="h-5 w-5 text-[#3bb9ac]" />
                    </div>
                    <div>
              ...
              <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-lg p-8 sm:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full sm:w-auto bg-gradient-to-r from-[#1F4068] via-[#3bb9ac] to-[#3bb9ac] hover:from-[#3bb9ac] hover:via-[#3bb9ac] hover:to-[#1F4068] text-white border-0 shadow-lg hover:shadow-xl transition-all px-8 py-6 text-lg font-semibold"
                  >
                    {isSubmitting ? (
